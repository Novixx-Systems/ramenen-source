; Yes, this is the bootloader used in pre-2.5 versions of Ramenen
; Changes since then: NVXRMN.COM changed to RMNKRNL.SYS
...
OEMLabel		db "RAMEBOOT"	; Disk label
...
VolumeLabel		db "RAMENEN    "; Volume Label: any 11 chars
...
fatal_disk_error:
	mov si, file_not_found		; If not, print error message and reboot
	call print_string
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "RMNKRNL SYS"	; Ramenen kernel filename

	file_not_found	db "Bad system disk.",13,10,"Insert system disk and retry.", 0
